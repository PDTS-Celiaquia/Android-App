...
class ListaDeRecetasFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        rvRecetas.adapter = context?.let { MyAdapter(getRecetas(), it) }
        return vista
    }

    private fun getRecetas(): ArrayList<Receta> { //deberia solicitar los datos a un web service
        val list = ArrayList<Receta>()
        list.add(Receta(R.drawable.canelones_pollo,
            "Canelones de pollo",
            "Belleza en forma de comida",
            4.5F
        ))
        list.add(Receta(R.drawable.crepes_bn,
            "Crepes",
            "Bueno, bonito y barato",
            1F
        ))
        list.add(Receta(R.drawable.empanadillas,
            "Empanadillas",
            "Nada como el repulgue de la abuela",
            4.5F
        ))
        list.add(Receta(R.drawable.ensalada_palta,
            "Ensalada de palta",
            "Excelente para comer algo rico y al paso",
            2.5F
        ))
        list.add(Receta(R.drawable.masa_pizza_sin_gluten,
            "Masa de pizza sin gluten",
            "Ideal para sentir que podes comer tacc",
            4.5F
        ))
        list.add(Receta(R.drawable.pastelchocolate,
            "Pastel de chocolate",
            "Para los amantes de lo dulce",
            5F
        ))
        list.add(Receta(R.drawable.tarta_fresas,
            "Tarta de fresas",
            "Rico y calculo que saludable",
            4F
        ))
        list.add(Receta(R.drawable.salmorejo,
            "Salmorejo",
